...
#!main player assets
PLAYER_SHIP = pygame.image.load(os.path.join("space invader/assets","player.png"))
BLUEBULLET = pygame.image.load(os.path.join("space invader/assets","bluebullet.png"))

#! enemy stuffs
REDSPACESHIP= pygame.image.load(os.path.join("space invader/assets","redspaceship.png"))
REDBULLET= pygame.image.load(os.path.join("space invader/assets","redbullet.png"))

GREENSPACESHIP= pygame.image.load(os.path.join("space invader/assets","greenspaceship.png"))
GREENBULLET= pygame.image.load(os.path.join("space invader/assets","greenbullet.png"))

YELLOWSPACESHIP= pygame.image.load(os.path.join("space invader/assets","yellowspaceship.png"))
YELLOWBULLET= pygame.image.load(os.path.join("space invader/assets","yellowbullet.png"))

#!background
BG= pygame.transform.scale(pygame.image.load(os.path.join("space invader/assets","bg.jpg")),(width,height))
